# MCP Server module - fastmcp is optional
try:
...
if not FASTMCP_AVAILABLE:
    # Provide stub exports when fastmcp isn't available
    mcp_server = None
    DynamicMcpProxy = None  # type: ignore
    ...
    class _StubProxy:
        ...
        def get_instance():
            return None
    DynamicMcpProxy = _StubProxy  # type: ignore
else:
    # Full implementation when fastmcp is available
    import os
    ...
    class DynamicMcpProxy:
        ...
        def reconfigure(self, token: str):
            ...
            with self._lock:
                ...
                # http_app disabled - using SSE only
                self.http_app = None